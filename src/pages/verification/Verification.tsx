...
const Verification: FC = () => {
	...
	const [canRequestVerification, setCanRequestVerification] =
		...
		<AnimatePresence>
			<motion.div className="flex font-poppins justify-center items-center h-screen w-screen no-select">
				{canRequestVerification ? (
					<motion.div
						className="flex bg-[#DBE2EF70] justify-center rounded-[10px] p-3 w-[80%] lg:p-5 hadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)]"
						initial={{ opacity: 0 }}
						animate={{ opacity: 1 }}
						exit={{ opacity: 0 }}
								...
								<div className="flex flex-col w-full justify-center items-center">
									<div className="flex flex-row justify-center">
										<img
											...
											alt="checked"
										/>
										<h1 className="text-xl place-self-center mx-2 text-[#112D4E]">
											Multi Email
										</h1>
									</div>
									<div className="flex flex-col text-center mt-5">
										<h1 className="text-xl font-regular text-[#3F72AF]">
											Authenticate Your Account
										</h1>
										<p className="text-sm m-3">
											Please confirm your account by
											entering the verification code sent
											to your email address.
										</p>
										<div className="flex flex-row justify-center items-center">
											<p className="text-[#5271FF]">
												{"thisisaniceemail@nice.mail"}
											</p>
										</div>
									</div>
									<div className="flex flex-col w-[80%] mt-5">
										...
										<div className="flex flex-col">
											...
											<input
												className={
													"outline-none border-2 border-white h-full rounded-md p-2 mt-2 transition-colors duration-300 " +
										...
										<div className="flex flex-col mt-5">
											...
											<button
												className="text-white rounded-md p-2 w-full cursor-pointer enabled:bg-[#5271FF] disabled:bg-red-500 disabled:cursor-not-allowed duration-500"
												disabled={
								...
								<div className="flex flex-col w-[80%] mt-5">
									...
									<div className="flex flex-col justify-between text-[11px] lg:text-[12px]">
										<p className="mt-3 mx-3 text-center">
											It may take a minute to receive your
											code.
										</p>
									</div>
								</div>
